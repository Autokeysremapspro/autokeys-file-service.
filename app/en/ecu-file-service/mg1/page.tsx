...
export const metadata: Metadata = {
  title: 'Bosch MG1 File Service for Professionals | AK Cloud',
  description: 'Professional Bosch MG1 ECU file service for workshops and tuners. Upload your original ECU read and manage calibration requests through AK Cloud.',
  alternates: { canonical: '/en/ecu-file-service/mg1', languages: { en: '/en/ecu-file-service/mg1', es: '/ecu-file-service/mg1', 'x-default': '/ecu-file-service/mg1' } },
}
