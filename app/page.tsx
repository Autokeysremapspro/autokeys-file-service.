    ...
    <main className="ak-v5-bg min-h-screen overflow-hidden text-white">
        ...
        <div className="mx-auto flex max-w-[1480px] items-center justify-between px-5 py-4 lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <div className="text-sm font-black tracking-[.18em]">AK <span className="text-[#e5a05d]">CLOUD</span></div>
        ...
        <div className="relative ak-v5-float">
          ...
          <div className="ak-v5-glass relative overflow-hidden rounded-[34px] p-3">
            <div className="flex items-center justify-between border-b border-white/[.07] px-4 py-3">
              <div className="flex gap-1.5"><i className="h-2.5 w-2.5 rounded-full bg-[#ff4964]" /><i className="h-2.5 w-2.5 rounded-full bg-[#e5a05d]" /><i className="h-2.5 w-2.5 rounded-full bg-[#53e6a8]" /></div>
            ...
            <div className="grid gap-3 p-3 sm:grid-cols-[180px_1fr]">
              <aside className="hidden rounded-2xl border border-white/[.07] bg-black/25 p-3 sm:block">
                <div className="mb-5 rounded-xl border border-[#e5a05d]/20 bg-[#e5a05d]/[.08] p-3 text-xs font-bold text-[#ffd09a]">+ Nuevo pedido</div>
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-3 gap-2">
                  ...
                  <div className="ak-v5-stat"><div className="text-[10px] uppercase text-white/30">Saldo</div><div className="mt-2 text-3xl font-black text-[#e5a05d]">0 cr.</div></div>
                </div>
                <div className="ak-v5-card p-4">
                  ...
                  <div className="mt-5 h-1.5 rounded-full bg-white/[.06]"><div className="h-full w-[86%] rounded-full bg-gradient-to-r from-[#e5a05d] to-[#67e8d1]" /></div>
      ...
      <section className="relative z-10 border-y border-white/[.06] bg-white/[.018]">
        <div className="mx-auto grid max-w-[1480px] grid-cols-2 gap-4 px-5 py-8 md:grid-cols-4 lg:px-8">
          {[['SIN CRÉDITOS', 'Precio claro por archivo'], ['WORKSPACE', 'Todo en un solo lugar'], ['TRAZABILIDAD', 'ORI, MOD y versiones'], ['ACCESO B2B', 'Solo profesionales']].map(([title, text]) => <div key={title} className="text-center"><div className="text-xs font-black tracking-[.18em] text-[#e5a05d]">{title}</div><div className="mt-1 text-sm text-white/35">{text}</div></div>)}
        </div>
      </section>
      ...
      <section id="precision" className="relative z-10 mx-auto max-w-[1480px] px-5 py-20 lg:px-8">
        <div className="ak-v5-glass grid overflow-hidden rounded-[34px] lg:grid-cols-2">
          ...
          <div className="relative min-h-[420px] border-t border-white/[.07] bg-black/25 p-8 lg:border-l lg:border-t-0"><div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(103,232,209,.11),transparent_55%)]" /><div className="relative mx-auto grid aspect-square max-w-[390px] place-items-center"><div className="absolute inset-[12%] rounded-full border border-[#67e8d1]/15 animate-[spin_18s_linear_infinite]" /><div className="absolute inset-[23%] rounded-full border border-dashed border-[#e5a05d]/20 animate-[spin_12s_linear_infinite_reverse]" /><div className="grid h-44 w-44 place-items-center rounded-full border border-white/10 bg-[#0a1018] shadow-[0_0_80px_rgba(103,232,209,.14)]"><div className="text-center"><Cpu size={32} className="mx-auto text-[#67e8d1]" /><div className="mt-3 text-4xl font-black">AK</div><div className="text-[10px] uppercase tracking-[.22em] text-white/30">Verified workflow</div></div></div></div></div>
        </div>
      </section>
