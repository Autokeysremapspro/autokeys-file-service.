...
export const metadata: Metadata = {
  title: 'Stage 1 File Service para profesionales',
  description: 'Stage 1 File Service para talleres y preparadores. Sube tu ORI, identifica vehículo y ECU y recibe tu calibración con soporte en AK Cloud.',
...
export default function Stage1FileServicePage() {
  ...
  const jsonLd = {
    ...
    url: 'https://www.akcloud.es/stage-1-file-service',
    provider: {
      '@type': 'Organization',
      name: 'AK Cloud',
    ...
    <main className="ak-v5-bg min-h-screen text-white">
      ...
      <section className="mx-auto max-w-[1100px] px-5 py-20 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2">
          <div>
            <div className="ak-v5-kicker">Qué necesitamos</div>
            <h2 className="ak-v5-title mt-4 text-4xl">Un ORI correcto y los datos técnicos del vehículo.</h2>
            <p className="mt-5 leading-7 text-white/45">Para valorar un Stage 1 necesitamos una lectura original íntegra y la identificación correcta del vehículo, motorización y unidad de control. Según la ECU y el protocolo, el tipo de lectura puede condicionar la información disponible para preparar el archivo.</p>
            <p className="mt-4 leading-7 text-white/45">El pedido conserva el ORI, el archivo entregado y la conversación técnica asociada. Esto permite revisar el historial del trabajo sin depender de mensajes dispersos y mantener una referencia clara si el vehículo necesita una revisión posterior.</p>
          </div>
          <div className="ak-v5-card p-7">
            <h2 className="text-2xl font-bold">Antes de escribir el archivo</h2>
            <p className="mt-4 leading-7 text-white/45">El profesional debe comprobar el estado mecánico del vehículo, ausencia de averías relevantes y compatibilidad de su herramienta con el protocolo de escritura. Una calibración Stage 1 no corrige problemas mecánicos ni electrónicos previos.</p>
            <p className="mt-4 leading-7 text-white/45">AK Cloud está diseñado como canal B2B: cada solicitud se gestiona por archivo, con precio visible según el servicio y seguimiento desde la misma cuenta profesional.</p>
          </div>
        </div>
      </section>
      <section className="mx-auto max-w-[1100px] px-5 pb-20 lg:px-8"><div className="ak-v5-card p-8 sm:p-10"><h2 className="ak-v5-title text-4xl">¿Tienes el ORI preparado?</h2><p className="mt-4 max-w-2xl leading-7 text-white/45">Crea tu cuenta profesional y empieza a gestionar tus solicitudes de archivos desde AK Cloud.</p><Link href="/register" className="ak-v5-button mt-7">Crear cuenta profesional <ArrowRight size={17}/></Link></div></section>
    </main>
  )
}
