...
const variants = {
  primary: 'border border-red-400/30 bg-[linear-gradient(135deg,#c9102b,#ff425a)] text-white shadow-[0_14px_42px_rgba(255,66,90,.28),inset_0_1px_0_rgba(255,255,255,.2)] hover:-translate-y-0.5 hover:shadow-[0_20px_58px_rgba(255,66,90,.38),inset_0_1px_0_rgba(255,255,255,.22)]',
